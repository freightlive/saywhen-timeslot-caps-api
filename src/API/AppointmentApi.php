...
class AppointmentApi
{
    ...
    /**
     * Operation registerAppointment
     *
     * Register Appointment
     *
     * @param \SayWhenTimeSlotCaps\Model\RegisterAppointmentPostModel $body RegisterAppointmentPostModel (required)
     * @throws \SayWhenTimeSlotCaps\ApiException on non-2xx response
     * @return \SayWhenTimeSlotCaps\Model\ApiResponse
     */
    public function registerAppointment($body)
    {
        list($response) = $this->registerAppointmentWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation registerAppointmentWithHttpInfo
     *
     * Register Appointment
     *
     * @param \SayWhenTimeSlotCaps\Model\RegisterAppointmentPostModel $body RegisterAppointmentPostModel (required)
     ...
     */
    public function registerAppointmentWithHttpInfo($body)
    {
